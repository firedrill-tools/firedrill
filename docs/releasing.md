...
Firedrill does not publish from a developer laptop. A release candidate is built
from committed, clean source in a controlled CI environment, and publication
