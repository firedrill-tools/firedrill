...
import { inspectInstalledToolPackage, ProjectConfigSchema, ToolSourceSchema } from "@firedrill-run/compiler";
import {
...
const STATEFUL_BEHAVIOR = `import { ToolFailure } from "@firedrill-run/tool-sdk";
